...
export function adjudicateProviderPrice(c,derived,receipt,{body,sourceUrl,source,scope={},canonicalIdentity=null}){
 ...
 const eligibilityCodes=new Set(['QUALIFIER_NOT_PRODUCT_IDENTITY','HEADING_PRODUCT_BINDING_UNRESOLVED','ZERO_COMMERCIAL_PHASE_UNRESOLVED']);
 ...
 const offerOwned=identitySafe&&!!c.productOwnerEvidence?.path&&!c.ownershipAmbiguous&&!c.crossCardRisk&&c.attribution?.productOwnershipEstablished===true;
