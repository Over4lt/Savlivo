...
test('Operations authentication checks have bounded timeouts beyond the old ten-second limit',()=>{
 ...
 assert.equal(timeout('v2-operations/preflight'),150000);assert.equal(timeout('v2-operations/start'),150000);assert.equal(timeout('v2-operations/targeting'),30000);assert.equal(timeout('overview'),10000);assert.equal(timeout('v2-operations/other'),10000);assert(source.includes('AbortSignal.timeout(operationsRequestTimeout(path))'));
});
